...
const questions = [
    {slug:'seventeen', title:'Er du fyldt 17 år på Nathejk?', type:'radio', options:['Ja', 'Nej'], defaults:[]},
    {slug:'days',title:'Deltager', type:'checkbox', options:['fredag', 'lørdag', 'søndag'], defaults:['fredag', 'lørdag', 'søndag']},
    {slug:'car',title:'Transport under Nathejk', type:'radio', options:['Jeg har egen bil', 'Jeg har brug for en plads'], defaults:[]},
    {slug:'seatcount',title:'Hvis du medbringer egen bil, hvor mange ekstra pladser har du?', type:'number', options:[], defaults:[]},
...
<template>
    ...
    <div class="container mx-auto">
        ...
        <Fieldset class="mt-3" legend="Kontaktinformation">
            ...
            <p class="mt-5">Deltager du sammen med din klan, og har I lyst til at få en opgave inden løbet? Hvis ja, skriv jeres klannavn.</p>
            <div class="flex flex-col">
                <FloatLabel class="mt-3">
                    <InputText id="team-name" v-model.trim="staffer.klan" size="small" class="w-full" required="true" autofocus :invalid="teamSubmitted && !staffer.klan" />
