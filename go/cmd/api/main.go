...
func main() {
	...
	*/
	...
	models := data.NewModels(tablePayment, tableStaff, tablePatrulje, tableSpejder, tableSenior, tableSignup, tableKlan, tableOrder, tableProduct, tableSection, tableCrewmember)
