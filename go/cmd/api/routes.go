...
func (app *application) routes() http.Handler {
	...
	router.HandlerFunc(http.MethodPost, "/api/klan/:id/member", app.addKlanMemberHandler)
	router.HandlerFunc(http.MethodPut, "/api/klan/:id/member/:memberId", app.updateKlanMemberHandler)
	router.HandlerFunc(http.MethodDelete, "/api/klan/:id/member/:memberId", app.deleteKlanMemberHandler)
	...
	router.HandlerFunc(http.MethodGet, "/api/crew/:id", app.showCrewHandler)
	router.HandlerFunc(http.MethodPut, "/api/crew/:id", app.updateCrewHandler)
	router.HandlerFunc(http.MethodGet, "/api/sections", app.listSectionsHandler)
	...
	router.HandlerFunc(http.MethodPost, "/api/migrate/legacy-orders", app.migrateLegacyOrdersHandler)
	router.HandlerFunc(http.MethodPost, "/api/migrate/staff-to-crew", app.migrateStaffToCrewHandler)
